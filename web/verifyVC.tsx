...
import tokyoUniversityLogoImg from './src/assets/tokyo-university-logo.png';
import driversLicenseLogoImg from './src/assets/drivers-license-logo.png';
import companyLogoImg from './src/assets/company-logo.png';
import cellularConnectionImg from './src/assets/cellular-connection.svg';
import wifiImg from './src/assets/wifi.svg';
import batteryImg from './src/assets/battery.svg';
import messageQuestionImg from './src/assets/message-question.svg';
import settingsIconImg from './src/assets/settings-icon.svg';
import homeIconImg from './src/assets/home-icon.svg';
...
export default function VerifyVc1() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-2 items-center justify-start relative size-full" data-name="Verify VC1" data-node-id="27:197">
      ...
      <div className="basis-0 bg-[#cfffd7] grow min-h-px min-w-px relative shrink-0 w-[400px]" data-name="VCFrame" data-node-id="27:210">
